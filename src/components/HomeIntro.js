      ...
      <section className="wrapper2">
        ...
        <div className="container">
          <div className=" contact_div">
            ...
            <a href="https://twitter.com/nakade_uttam" target="_blank" rel="noopener norefer"><i className="fa-brands fa-x-twitter fa-xl" style={{color: "#0d0d0d"}}></i></a>
            <a href="https://www.facebook.com/profile.php?id=100073788919787&mibextid=ZbWKwL" target="_blank"><i className="fa-brands fa-facebook fa-xl" style={{color: "#2e6cd6"}}></i></a>
            <a href="https://www.instagram.com/nakadeuttam96?igsh=MWk4Y2R3Z3Q3eGZwNw==" target="_blank"><i className="fa-brands fa-instagram fa-xl" style={{color: "#de6bf5"}}></i></a>
            <a href=""><i className="fa-brands fa-telegram fa-xl" style={{color: "#527dc7"}}></i></a>
            </ul>
          </div>
